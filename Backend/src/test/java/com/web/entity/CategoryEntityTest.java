...
class CategoryEntityTest {
    ...
    void setUp() throws Exception {
        category=new CategoryEntity(1L,"travel",5000L,"active");
    }
    ...
    void testConstructorsStringLongString() {
        category =new CategoryEntity(1L,"internet",1000L,"active");
        assertNotNull(category);
    }
    
    @Test
    void testAllArgsConstructor() {
        category=new CategoryEntity(2L,"internet",1000L,"active");
        assertNotNull(category);
    }
